...
#   2- get_lower()
#   3- get_vigenereSquare()
#   4- get_freqTable()
#   5- get_charCount(text)
#   6- shift_string(s,n,d)
#   7- get_chiSquared(text)
#   8- load_dictionary(dictFile)
#   9- text_to_words(text)
#   10- analyze_text(text, dictFile)
#   11- is_plaintext(text, dictFile, threshold)
#   12- e_shift(plaintext,key)
#   13- d_shift(ciphertext,key)
#   14- cryptanalysis_shift(ciphertext)
...
#               If cryptanalysis faile: print error and returns '',''
#---------------------------------------------------------------------------------------
